...
def get_struc_seq(foldseek,
                  ...
                  tmp_save_path: str = 'get_struc_seq_0.csv') -> dict:
    """
...
if __name__ == '__main__':
    ...
    struct_data_root = Path(args.structure_data_folder)
    for i, fpath in enumerate(struct_data_root.glob('*pdb')):
        struc_seq = get_struc_seq(args.foldseek_bin, str(fpath), ["A"], plddt_mask=True, plddt_threshold=70)["A"][1].lower()
