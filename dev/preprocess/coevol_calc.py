...
def run(args):
    ...
    x = F.one_hot(x.type(torch.int64), num_classes=A).type(torch.float32)
...
def main():
    ...
    parser.add_argument("-f", "--feature_dir", help="gMVP feature directory",
                        default="/share/terra/backups/MVPContext/combined_feature_2021_v2")
