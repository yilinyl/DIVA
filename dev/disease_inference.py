...
if __name__ == '__main__':
    ...
    save_pheno_results(test_pheno_results, pheno_result_path, split='test', save_emb=True)
    save_pheno_results(val_pheno_results, pheno_result_path, split='val', save_emb=True)